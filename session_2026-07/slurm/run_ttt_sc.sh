#!/bin/bash
#SBATCH --job-name=gsm_sc
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --array=0-1
#SBATCH --output=/mnt/scratch2/users/hchen/logs/gsm_sc_%A_%a.log
set -uo pipefail
...
echo "== SC-TTT on $A =="
python -u ttt_sc.py --adapter "$A" --base_model meta-llama/Llama-2-7b-hf --limit 40 --n 8 --ttt_steps 5 --ttt_lr 2e-5 --temp 0.8
echo "SC_DONE $A"
